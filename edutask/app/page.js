...
export default function Home() {
  return (
    ...
    <section className="flex flex-col justify-center items-center h-screen">
      ...
      <div className=" border-2 border-black flex flex-col justify-center items-center rounded-lg p-10 m-10  .h-2/5 md:w-1/2 lg:w-1/2 sm:w-1/2 bg-purple">
         ...
         <button className=" bg-black text-white rounded-lg p-2 w-1/2 mt-6 border-2 border-black">Login</button>
